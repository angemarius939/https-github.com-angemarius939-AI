          ...
          {menuItems.map((item) => (
            ...
            >
              ...
              {unreadCounts[item.id] > 0 && (
                <span className={`absolute right-3 flex items-center justify-center min-w-[20px] h-5 px-1.5 text-[10px] font-bold rounded-full ${
                   currentView === item.id 
                   ? 'bg-emerald-600 text-white' 
                   : 'bg-red-500 text-white shadow-sm ring-2 ring-black/20'
                }`}>
